 ...
 *	   else - 0.
 *
 * Description: Prints each  variable per line in the
...
/**
 * shellby_setenv - Change or adds an environmental variable to the PATH.
 * @args: Array of arguments passed to the shell.
 * @front: Double pointer to the beginning of args.
 ...
 * @args: Array of arguments passed to the shell.
 * @front: Double pointer to the beginning of args.
 * Description: args[1] PATH variable to remove.
 *
 * Return: If an error occurs - -1.
 *         else - 0.
 */
